...
func (c *GoDEX) OrderInfo(req instantswap.TrackingRequest) (res instantswap.OrderInfoResult, err error) {
	var r []byte
	r, err = c.client.Do(API_BASE, "GET", fmt.Sprintf("transaction/%s", req.OrderId), "", false)
	if err != nil {
		return res, err
	}
	var tx Transaction
